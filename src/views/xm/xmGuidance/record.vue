<template>
    <el-dialog  title="指导记录" :visible.sync="visible" width="1050px" :close-on-click-modal="false" @close='closeDialog'>
            <div class="add">
            ...
            <el-table ref="table" header-row-class-name="table-header-row" cell-class-name="cell-row" :data="tableData" border stripe fit highlight-current-row v-loading="listLoading" element-loading-text="正在加载中……">
                ...
                <el-table-column align="center" prop="processRecord" label="指导记录"  min-width="90"></el-table-column>
