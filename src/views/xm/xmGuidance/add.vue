    ...
    <div>
        <el-dialog  title="新增" :visible.sync="visible1" width="500px" :close-on-click-modal="false" :append-to-body='true' @close='closeDialog'>
            <el-form ref="form" :rules="rules" :model="formData" label-width="100px" label-position="right">
                <el-form-item label="指导记录:" prop="processRecord">
                    <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}"  placeholder="指导记录" v-model="formData.processRecord"></el-input>
                </el-form-item>
            </el-form>
...
export default {
    data(){
        return{
            ...
            rules:{
                processRecord:[{required:true,message:'指导记录不能为空'}],
            },
            visible1:false,
        }
    },
