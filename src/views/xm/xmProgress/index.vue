        ...
        <div class="tabel">
            <el-table ref="table" header-row-class-name="table-header-row" cell-class-name="cell-row" :data="tableData" border stripe fit highlight-current-row v-loading="listLoading" element-loading-text="正在加载中……">
                ...
                <el-table-column align="center" label="操作"  min-width="150">
                    <template slot-scope="scope">
                        <el-button type="text" @click="progress(scope.row)" icon="el-icon-edit">进展记录</el-button>
                        <el-button type="text" @click="end(scope.row)" icon="el-icon-edit">项目结束</el-button>
                    </template>
                </el-table-column>
            </el-table>
